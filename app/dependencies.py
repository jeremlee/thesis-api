...
extra_transcript_prompt = "dont give me anything but a json with 4 fields(sentimental_analysis, personality_traits, communication_style_insights, interview_insights)" \
                ...
                "\nTranscript: " #used in transcribe.py
