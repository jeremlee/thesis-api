...
class TranscriptFormat(BaseModel):
    ...
    sentimental_analysis_phrases: list[str]
    personality_traits: str
    personality_traits_phrases: list[str]
    communication_style_insights: str
    communication_style_insights_phrases: list[str]
    interview_insights: str
    interview_insights_phrases: list[str]
    cultural_fit_insights: str
    cultural_fit_insights_phrases: list[str]
